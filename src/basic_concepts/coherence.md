...
As well as making overlap rules MUCH simpler, this has a really powerful benefit for implementation. (I believe that) with it, we can fully erase constraints (instead keeping tags around at runtime, and dispatching based off the outer tag).
